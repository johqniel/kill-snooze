        ...
        <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="container" style={{ flex: 1, padding: '40px 20px', maxWidth: '800px', margin: '0 auto' }}>
                ...
                <section style={{ marginBottom: '40px' }}>
                    ...
                    <p style={{ lineHeight: '1.6', marginBottom: '15px' }}>
                        Sie haben jederzeit das Recht auf unentgeltliche <strong>Auskunft</strong> über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung sowie ein Recht auf <strong>Berichtigung</strong>, <strong>Löschung</strong> oder <strong>Einschränkung</strong> dieser Daten. Des Weiteren haben Sie das Recht auf Datenübertragbarkeit und Widerspruch gegen die Verarbeitung. Da wir Daten unmittelbar nach Zweckerfüllung löschen, laufen diese Rechte in der Praxis oft ins Leere, bestehen aber formaljuristisch uneingeschränkt.
                    </p>
                    ...
                    <p style={{ lineHeight: '1.6', marginBottom: '15px' }}>
                        Unsere Website wird teilweise über Werbeanzeigen auf Plattformen wie Instagram (Meta Platforms Ireland Ltd.) beworben. Wenn Sie über eine solche Anzeige auf unsere Seite gelangen, können technische Daten (z.B. Referrer-Informationen) übertragen werden. Wir nutzen diese Daten nicht zur Erstellung von Nutzerprofilen. Beachten Sie jedoch, dass die jeweiligen Plattformbetreiber eigene Tracking-Technologien einsetzen können.
                    </p>
                </section>
